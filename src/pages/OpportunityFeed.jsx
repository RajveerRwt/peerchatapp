          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6 relative pb-[70px]">
            ...
            {selected.file_url && (
              <a
                ...
                className="block mt-5 text-center px-5 py-2 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 text-pink-900 font-semibold hover:scale-105 transition-transform"
              >
                🔗 Visit Link
              </a>
            )}

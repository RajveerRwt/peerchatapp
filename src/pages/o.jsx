  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black to-blue-900 p-4 text-white">
      {!connected ? (
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-center">🎓 RGPV Peer Chat</h2>
          <input
            type="text"
          ...
          <button
            onClick={handleStart}
            className="w-full py-2 bg-blue-500 hover:bg-blue-600 rounded text-black"
          >
            Start Chatting
          </button>
        ...
        <div className="bg-gray-900 w-full max-w-md rounded-lg p-4 shadow-md flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={sendMessage}
              className="bg-black-500 hover:bg-black-600 text-black px-4 py-2 rounded"
            >
              Send
            </button>
          </div>
